...
namespace ProduktFlow2.Core.Services
{
    public class ProductService
    {
        ...
        {
            // Gem direkte i databasen via SP og returnér nyt produkt ID
            return _repo.SaveStep1(dto);
        }
        ...
        public void SaveStep5Answers(Step5Dto dto)
        {
            _repo.SaveStep5(dto);
        }
        ...
        {
            _repo.UpdateProductStatus(productId, status);
        }
